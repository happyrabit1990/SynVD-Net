...
#   return nn.Conv2d(in_channels, out_channels, kernel_size=5, stride=1, padding=2)
...
class MSRAB(nn.Module):
  def __init__(self, in_channels, out_channels):
    ...
    self.conv3x3_1 = nn.Sequential(conv3x3(in_channels, out_channels), nn.BatchNorm2d(out_channels))
