...
parser = argparse.ArgumentParser(description="RDN_Test")
...
def RDN_infer(test_files_gt, test_files, save_dir, Height, Width):
...
if __name__ == "__main__":
    ...
    net = RDN(channel=1, rdb_number=8)
    model = net.to(device)
    ...
    RDN_infer(test_files_gt, test_files, save_file, Height, Width)
